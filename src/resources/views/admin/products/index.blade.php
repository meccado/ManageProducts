...
@section('title')
     {{-- this page title --}}
     {!!(isset($title)) ? $title : 'Products List'!!}
@stop
...
@section('content')
    ...
    <p>{!! link_to_route('admin.products.create', trans('product.products-index-add_new'), [], ['class' => 'btn btn-success btn-flat'])
    !!}</p>
        ...
        <div class="box box-primary"><!-- .box -->
            <div class="box-header with-border"><!-- .box-header -->
                ...
                <h3 class="box-title pull-left">
                    {{ trans('product.products-index-products_list') }}
                </h3>
            </div><!-- /.box-header -->
            ...
            <div class="box-footer"><!-- .box-footer-->
              {{ trans('product.products-index-footer') }}
            </div><!-- /.box-footer-->

        </div><!-- /.box -->

    @else
        {{ trans('product.products-index-no_entries_found') }}
    @endif
