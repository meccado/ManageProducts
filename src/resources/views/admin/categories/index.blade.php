...
@section('content')
    ...
    <p>{!! link_to_route('admin.categories.create', trans('mng_product::category.categories-index-add_new'), [], ['class' => 'btn btn-success btn-flat'])
    !!}</p>
        ...
        <div class="box box-primary"><!-- .box -->
            <div class="box-header with-border"><!-- .box-header -->
                ...
                <h3 class="box-title pull-left">
                    {{ trans('mng_product::category.categories-index-categories_list') }}
                </h3>
            </div><!-- /.box-header -->
            ...
            <div class="box-footer"><!-- .box-footer-->
              {{ trans('mng_product::category.categories-index-footer') }}
            </div><!-- /.box-footer-->

        </div><!-- /.box -->

    @else
        {{ trans('mng_product::category.categories-index-no_entries_found') }}
    @endif
